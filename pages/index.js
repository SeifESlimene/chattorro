  ...
  return (
    <div className='py-0 px-8'>
      ...
      <main className='min-h-screen py-16 px-0 flex flex-col justify-center items-center basis-0 grow shrink'>
        ...
        <h1 className='font-caveat text-5xl bold'>
          Chattorro App.
        </h1>
        <br/>
        {getStarted ? (
        <>
          ...
          <a href="" className="flex w-full items-center font-bold tracking-wide bg-stone-900 text-yellow-500 hover:bg-stone-800 justify-center rounded-md border border-transparent px-8 py-3 text-base font-medium md:py-4 md:px-10 md:text-lg">Get Started</a>
        </div>}
      </main>
